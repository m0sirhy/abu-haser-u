<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        <h3 class="box-title" style="margin-bottom: 15px">@lang('site.clients') <small>اجمالي الاستهلاك :@if (auth()->user()->hasRole('super_admin')) {{$clients->sum('consume')}}  @endif</small></h3>
